...
export const store = new Vuex.Store({
	state: {
		regularExpression: {
            regName: /^[ ضصثقفغعهخحجآچپشسیبلاتنمکگظطزرذدئو]{3,25}$/,
            regUsername: /^[a-zA_Zضصثقفغعهخحجچپشسیبلاتنآمکگظطزرذدئو0-9]{3,25}$/gi,
            regPassword: /^[\u06F0-\u06F90-9a-zA-Z0-9ضصثقفغعهخحجآچپشسیبلاتنمکگظطزرذدئو ]{4,20}$/g,
            reg_phoneNumber: /^[0-9\u06F0-\u06F90-9]{11}$/gi,
            regEmail: /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,
			regNameCompany: /^[ًٌٍ،؛َُِّۀآـ«»,:"ةيژؤإأء<> -؟ضصثقفغعهخحجچپشسیبلاتنمکگظطزرذدئو./a-zA-z0-9\u06F0-\u06F90-9]{3,64}$/,
			regAddressCompany: /^[ًٌٍ،؛َُِّۀآـ«»,:"ةيژؤإأء<> -؟ضصثقفغعهخحجچپشسیبلاتنمکگظطزرذدئو./a-zA-z0-9\u06F0-\u06F90-9]{3,150}$/,
        },
		isSubMenuOpen: false,
		url: null,
		categoriesTop: null,
