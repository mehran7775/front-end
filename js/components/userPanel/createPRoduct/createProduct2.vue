...
export default {
  ...
  mounted(){
    document.querySelector('.wizard-navigation ul').style.display="none"
    document.querySelector('.wizard-navigation .wizard-progress-with-circle').style.display="none"
    document.querySelector('.wizard-footer-right').style.float="none"
    document.querySelector('.wizard-footer-right').style.textAlign="center"
  },
  computed: {
    errors_u() {
      if (this.errors != "None") {
